...
const parent = {
  name: "Susan",
  age: 70,
  parentSpeak(){return "Im Mom/Dad";},
  child: {
    name: "George",
    age: 50,
    childSpeak(){return "Im the child"},
    grandchild: {
      name: "Sam",
      age: 30,
      grandChildSpeak(){return "Im the Grandchild"},
    }
  }
}
...
console.log(parent.child.grandchild.grandChildSpeak());